...
export default function AIAssistantPage() {
  ...
  const [apiKey, setApiKey] = useState('sk-38b067ef538a4e859e2c5839af55985d')
          ...
          <CardContent>
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                <span className="text-[#b0aea5] w-20">提供商:</span>
                <span className="text-[#141413] font-medium">DeepSeek</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#b0aea5] w-20">状态:</span>
                <Badge className="bg-[#788c5d] text-white">已连接</Badge>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#b0aea5] w-20">模型:</span>
                <span className="text-[#141413] font-mono text-xs">deepseek-chat</span>
              </div>
            </div>
          </CardContent>
        </Card>
