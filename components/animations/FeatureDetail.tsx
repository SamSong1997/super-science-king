      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className={`grid lg:grid-cols-2 gap-8 lg:gap-12 items-center ${reverse ? 'lg:flex-row-reverse' : ''}`}>
          ...
          >
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#141413] font-bold mb-4 md:mb-6 leading-tight">
                {title}
              </h2>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-[#788c5d] leading-relaxed"
            >
              {description}
            </motion.p>
          </motion.div>
